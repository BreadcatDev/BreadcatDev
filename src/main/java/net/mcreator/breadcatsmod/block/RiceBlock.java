...
import net.mcreator.breadcatsmod.item.RicecornsItem;
...
public class RiceBlock extends BreadcatsModModElements.ModElement {
	@ObjectHolder("breadcats_mod:rice")
	public static final Block block = null;
	public RiceBlock(BreadcatsModModElements instance) {
		super(instance, 20);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("breadcats_mod:rice"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.CROP).hardnessAndResistance(0.3f, 0f)
					.setLightLevel(s -> 0));
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RicecornsItem.block, (int) (2)));
		}
